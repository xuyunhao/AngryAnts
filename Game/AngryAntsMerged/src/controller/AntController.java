...
//	}
	...
	private void init(final Stage primaryStage) throws MalformedURLException,
		...
		musicFile = new Media(getClass().getResource("/sound/ElectroSwing.mp3").toString());
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.getIcons().add(new Image(getClass().getResource("/img/ant2.png").toString()));
...
//	}
	...
	public void userStart() {
		...
		// If going from the tutorial screen, remove tutorial
