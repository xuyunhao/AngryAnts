...
public class IntroScreen extends Region {
	...
	private static String imageView;
	private AntController controller;
	private double width, height;
	
	private Button button5 = new Button();
	private ImageView im1 = new ImageView(new Image(getClass().getResource(
			"/img/sound.png").toString(), 36, 36, false, true));
	private ImageView im2 = new ImageView(new Image(getClass().getResource(
			"/img/Nosound.png").toString(), 36, 36, false, true));
...
//				+ "/bin/img/AngryAnts.png");
		Image image = new Image(getClass().getResource("/img/AngryAnts.png").toString());
