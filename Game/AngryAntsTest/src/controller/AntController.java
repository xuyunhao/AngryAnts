...
public class AntController extends Application {
	...
	private void init(final Stage primaryStage) throws MalformedURLException,
		...
		root5 = new Group();
		root6 = new Group();
		cView = new CreateView(root4, this);
		uView = new UserView(root3, this);
		intro = new IntroScreen(root2, this);
		gView = new GuestView(root5, this);
		tutorial = new Tutorial(root6, this);
		s = new Scene(root);
