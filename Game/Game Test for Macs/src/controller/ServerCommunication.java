...
public class ServerCommunication {
	...
	public String sendRequest(String typeRequest, String user, String password) {
		if (typeRequest.equals("LOGIN")) {
			String response = excutePost(
					"http://yi-huang.org/AngryAnts/processlogin.php",
			...
			String response = excutePost(
					"http://yi-huang.org/AngryAnts/adduser.php", "username="
			...
			String response = excutePost(
					"http://yi-huang.org/AngryAnts/pickant.php", "");
			return response;
		}
		return "";
	}
	...
	public String uploadFile(String contents, String user, String vidID, String antId, String vidId2){
		return excutePost("http://yi-huang.org/AngryAnts/handleupload.php?vid="+vidID +"&aid=" + antId + "&vid2="+vidId2 +"&credential=" + user, contents);
	}
