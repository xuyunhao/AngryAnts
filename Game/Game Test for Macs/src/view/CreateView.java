...
public class CreateView extends Region {

	private AntController controller;
	double width, height;
	//private Group root;

	public CreateView(AntController controller, double mWidth, double mHeight) {
		//super(arg0, 400, 400);
	...
	private void initScene() {
		...
		create.setTranslateX(this.width - (this.width - 30));
		...
		goback.setTranslateX(this.width - 75);
		goback.setTranslateY(this.height - 75);
		...
		this.getChildren().addAll(create, goback);
