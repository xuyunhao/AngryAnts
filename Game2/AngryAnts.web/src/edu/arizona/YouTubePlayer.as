package edu.arizona {
	...
	public class YouTubePlayer {
		...
		// video IDs
		private var VID_ID1_1X:String = "lYG8s4Rl0cM";//"lYG8s4Rl0cM"; //"wlY6aUIfe2w";
		private var VID_ID1_2X:String = "1w66GztlIoY";//"1w66GztlIoY"; //"12xLthgyr-g";
		private var VID_ID1_4X:String = "Ep1IFp1T2NI";//"Ep1IFp1T2NI"; //"lYG8s4Rl0cM";
